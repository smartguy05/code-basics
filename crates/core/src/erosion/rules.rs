...
pub fn builtin_rules() -> Vec<ErosionRule> {
    ...
    vec![
        ...
        r(
            ...
            WidenedCatch,
            Added,
            r"catch\s*\(\s*(System\.)?Exception",
            "A catch was widened to Exception.",
            CS,
            false,
        ),
        r(
            ...
            Added,
            r"catch\s*\{",
            "An exception is caught and swallowed.",
            CS,
            false,
        ),
        r(
            "cs-removed-null-guard",
            RemovedNullCheck,
            Removed,
            r"ArgumentNullException|==\s*null|!=\s*null",
            "A null guard was removed.",
            CS,
            false,
        ),
        r(
            ...
            "A compiler warning was disabled.",
            CS,
            false,
        ),
        r(
            ...
            "A NotImplementedException was left behind.",
            CS,
            true,
        ),
        r(
            ...
            Added,
            r"//\s*(TODO|FIXME)\b",
            "A TODO/FIXME was left in the code.",
            CS,
            true,
        ),
        r(
            "cs-removed-safeguard",
            RemovedSafeguard,
            Removed,
            r"Timeout|CancellationToken|Polly|\bretry",
            "A timeout, retry, or cancellation was removed.",
            CS,
            false,
        ),
        r(
            ...
            DroppedLog,
            Removed,
            r"_logger\.|ILogger|\bLog\.(Info|Warn|Error|Debug)",
            "A log line was removed.",
            CS,
            false,
        ),
        ...
        r(
            ...
            IgnoredTest,
            Added,
            r"\.skip\(|\bxit\(|\bxdescribe\(|it\.todo\b",
            "A test was skipped.",
            TS,
            false,
        ),
        r(
            ...
            Added,
            r"catch\s*(\([^)]*\))?\s*\{\s*\}",
            "An error is caught and swallowed.",
            TS,
            false,
        ),
        r(
        ...
        r(
            ...
            "A type error was suppressed.",
            TS,
            false,
        ),
        r(
            "ts-removed-null-guard",
            RemovedNullCheck,
            Removed,
            r"===?\s*null|!==?\s*null|===?\s*undefined",
            "A null/undefined guard was removed.",
            TS,
            false,
        ),
        r(
            ...
            LeftoverStub,
            Added,
            r#"throw new Error\(\s*['"]not implemented"#,
            "A not-implemented stub was left behind.",
            TS,
            true,
        ),
        r(
        ...
        r(
            "ts-removed-safeguard",
            RemovedSafeguard,
            Removed,
            r"AbortSignal|\btimeout\b|\bretry\b",
            "A timeout or retry was removed.",
            TS,
            false,
        ),
        r(
            ...
            DroppedLog,
            Removed,
            r"console\.(log|warn|error|info)|logger\.",
            "A log line was removed.",
            TS,
            false,
        ),
        ...
        r(
            ...
            Added,
            r"\.unwrap\(\)|\.expect\(",
            "A panic path (unwrap/expect) was introduced.",
            RS,
            false,
        ),
        r(
            ...
            Added,
            r"\bunsafe\s*\{",
            "An unsafe block was introduced.",
            RS,
            false,
        ),
        r(
            ...
            "A todo!/unimplemented! was left behind.",
            RS,
            true,
        ),
        r(
        ...
        r(
            ...
            DroppedLog,
            Removed,
            r"tracing::(info|warn|error|debug)|log::(info|warn|error|debug)",
            "A log line was removed.",
            RS,
            false,
        ),
        ...
        r(
            ...
            Added,
            r"AKIA[0-9A-Z]{16}",
            "An AWS access key id was hardcoded.",
            &[],
            false,
        ),
        r(
        ...
        r(
            ...
            Secret,
            Added,
            r#"(?i)\b(api[_-]?key|secret|token|password|passwd|pwd|access[_-]?key)\b\s*[:=]\s*["'](?:[^$<{%])[^"'\s]{11,}["']"#,
            "A credential was assigned to a hardcoded literal.",
            &[],
            false,
        ),
        r(
