...
const DECLARING: &[&str] = &[
    "fn", "func", "function", "def", "class", "struct", "enum", "interface", "trait", "impl",
    "type", "record", "namespace", "module", "const", "let", "var", "public", "private",
    "protected", "internal", "static", "async", "export", "default", "abstract", "override",
    "virtual", "sealed", "partial", "readonly", "unsafe", "extern", "pub",
];
