...
- Background project tabs now reflect hidden work with severity-aware lifecycle.
- Appearance settings cover themes, UI/code fonts, sizes, syntax, diffs, and terminals.
